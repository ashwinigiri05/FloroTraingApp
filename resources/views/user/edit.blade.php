        ...
        <div class="card">
            ...
            <form method="post" action = "/user/{{ $user->id }}">
                ...
                <div class="form-group row">
                    ...
                    <span class="text-danger">*</span>
                    <div class="col-md-6">
                        <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-danger' : '' }}" name="password" value="{{ old('password') }}">
                ...
                <div class="form-group row">
                    ...
                    <span class="text-danger">*</span>
                    <div class="col-md-6">
                        <input id="confmpassword" type="password" class="form-control{{ $errors->has('confmpassword') ? ' is-danger' : '' }}" name="confmpassword"  >
